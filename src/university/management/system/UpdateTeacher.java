...
public class UpdateTeacher  implements ActionListener{
    ...
    new UpdateTeacher().f.setVisible(true);
     ...
     UpdateTeacher(){
        f=new JFrame("Update Teacher Ditails");
        f.setBackground(Color.white);
        f.setLayout(null);
        
        
        
        JLabel l1 = new JLabel("Enter roll number to update the data of Techer");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String k =t11.getText();
         String o =t13.getText();
          String p =t14.getText();
        ...
        try{  
            conn cc =new conn();
            String q = "update teacher values('"+a+"' , '"+n+"' , '"+c+"' ,'"+d+"' , '"+e+"' , '"+m+"' , '"+g+"' , '"+h+"' , '"+i+"' , '"+j+"' ,'"+k+"','"+o+"', '"+p+"'";
        ...
        try{
          ...
          conn con = new conn();
        String str= "select * from teacher where rollno = '"+t12.getText()+"'";
