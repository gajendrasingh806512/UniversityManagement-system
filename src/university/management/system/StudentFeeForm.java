...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    Choice c1;
     ...
     public StudentFeeForm(){
         ...
         c1.setForeground(new Color(47,79,79));
          c1.setFont(new Font("Trechucher MS",Font.BOLD,16));
        ...
        // l1.add(c1);
         ...
         // l5.setForeground(new Color(25,25,112));
          ...
          contentPane.add(l5);
           ...
           JLabel l6 = new JLabel("Tatal Payable");
         ...
         // t2.setForeground(new Color(47,79,79));
          t2.setFont(new Font("Trechucher MS",Font.BOLD,16));
          t2.setColumns(10);
         ...
         // t3.setForeground(new Color(47,79,79));
          t3.setFont(new Font("Trechucher MS",Font.BOLD,16));
          t3.setColumns(10);
          ...
          t3.setText(rs.getString("fathers_name"));
           ...
           // comboBox.setForeground(new Color(47,79,79));
            ...
            comboBox.setFont(new Font("Trebucher MS", Font.BOLD,14));
            ...
            comboBox_2.setFont(new Font("Trebucher MS", Font.BOLD,14));
            contentPane.add(comboBox_2);
            
            
             t1 = new JTextField();
         // t1.setForeground(new Color(47,79,79));
          t1.setFont(new Font("Trechucher MS",Font.BOLD,16));
          t1.setColumns(10);
       ...
       b2.addActionListener(this);
        ...
        JLabel l7 = new JLabel("Course");
          ...
          comboBox_3 = new JComboBox();
            comboBox_3.setModel( 
                    new DefaultComboBoxModel(new String[]{"B.Tech", "M.Tech", "MBA", "BBA", "BCA", "B.Sc","MCA","Diploma" }));
            comboBox_3.setForeground(new Color(211,211,211));
            comboBox_3.setBounds(176,176,154,20);
            comboBox_3.setFont(new Font("Trebucher MS", Font.BOLD,14));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
              conn con = new conn();
              String sql = "insert into fee(rollno, name, father_name , course, branch , semester , fee_paid) values(?, ?, ?, ?, ?, ?,?)";
              
              PreparedStatement pt = con.c.prepareStatement(sql);
              pt.setString(1,c1.getSelectedItem());
              pt.setString(2,t2.getText());
              pt.setString(3,t3.getText());
              pt.setString(4, (String) comboBox_3.getSelectedItem());
               pt.setString(5, (String) comboBox.getSelectedItem());
                pt.setString(6, (String) comboBox_2.getSelectedItem());
                   pt.setString(7,t1.getText());
