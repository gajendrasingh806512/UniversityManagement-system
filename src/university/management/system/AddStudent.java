...
public class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("university/management/system/icans/fourth.jpg"));
        Image i3 = img.getImage().getScaledInstance(1220,700,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);
        
        id8 = new JLabel("New Student Details");
        id8.setFont(new Font("serif",Font.BOLD| Font.ITALIC,36));
        ...
        String course[] = {"B.tech","BBA","BCA","Bsc","Msc","MBA","MCA","Diploma","BA","BCom"};
        ...
        String branch[] = {"Computer Science","Electrical","Electronics","Mechanical","Civil"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{  
            ...
            JOptionPane.showMessageDialog(null,"Student Detials Inserted Succefully");
            f.setVisible(false);
            ...
            JOptionPane.showMessageDialog(null,"Student Detials Not Inserted ");
