...
public class AddTeacher implements ActionListener{
    ...
    long first = Math.abs(first4);
     ...
     public AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("university/management/system/icans/fifth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{  
            ...
            JOptionPane.showMessageDialog(null,"Teacher Detials Inserted Succefully");
          f.setVisible(false);
            ...
            JOptionPane.showMessageDialog(null,"Teacher Detials not Inserted ");
